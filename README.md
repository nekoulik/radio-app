...
AniWave Radio поддерживает тёмную и светлую темы:
- **Тёмная тема** (по умолчанию): Идеальна для ночного прослушивания
- **Светлая тема**: Комфортна при дневном использовании
- Выбор темы сохраняется в localStorage и применяется мгновенно

## ⌨️ Горячие клавиши

Управляйте плеером с клавиатуры:
- `Пробел` — Play/Pause
- `←` / `→` — Переключение станций
- `↑` / `↓` — Регулировка громкости
- `M` — Выключить/включить звук (Mute)

## 🕐 История прослушивания

Приложение запоминает последние 10 прослушанных станций и автоматически возвращается к последней при повторном входе.

        ...
        children: [
            ...
            /*#__PURE__*/ _jsx(FocusTrap, {
                ...
                children: /*#__PURE__*/ _jsx(RootComponent, {
                    ...
                    role: "dialog",
                    "aria-modal": "true",
                    className: classNames(className, styles.host, isDesktop ? styles.hostDesktop : styles.hostMobile, !isDesktop && (hasCustomPanelHeaderAfter ? styles.hostMobileSafeAreaInsetTopWithCustomOffset : styles.hostMobileSafeAreaInsetTop), desktopMaxWidthClassName),
